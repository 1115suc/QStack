...
![provide inject场景](1682329516878.png)
...
```shell
# 格式化单个文件
npx eslint --fix D:/Develop/FrontProject/dtsvue/src/views/DigitalTwinPlayer.vue
# 格式化多个文件
