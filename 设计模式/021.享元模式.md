...
![俄罗斯方块.jpeg](img/俄罗斯方块.jpeg)

**先来看类图：**

![享元模式.png](img/享元模式.png)
...
![Integer 享元模式示例.png](img/image-20200208212930857.png)
...
可以看到 `Integer` 默认先创建并缓存 `-128 ~ 127` 之间数的 `Integer` 对象，当调用 `valueOf` 时如果参数在 `-128 ~ 127`
