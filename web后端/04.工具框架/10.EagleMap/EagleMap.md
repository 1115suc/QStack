...
EagleMap 是一个功能强大、简单易用、支持多地图服务商的中台服务系统，旨在简化业务系统对地图服务的调用。目前支持国内主流的两大地图服务商。
...
| 项目                     | 源码仓库地址                                                                 |
|--------------------------|------------------------------------------------------------------------------|
| EagleMap                 | [Gitee](https://gitee.com/itcastopen/EagleMap.git)<br>[GitHub](https://github.com/itcastopen/EagleMap.git) |
| EagleMap-sdk             | [Gitee](https://gitee.com/itcastopen/EagleMap-sdk.git)<br>[GitHub](https://github.com/itcastopen/EagleMap-sdk.git) |
| eaglemap-spring-boot-starter | [Gitee](https://gitee.com/itcastopen/eaglemap-spring-boot-starter.git)<br>[GitHub](https://github.com/itcastopen/eaglemap-spring-boot-starter.git) |

### 开发文档

- [EagleMap 开发文档](https://eaglemap.itheima.net/#/zh-cn/)
...
```yaml
eagle:
  host: 127.0.0.1   # EagleMap 服务地址
  port: 8484        # EagleMap 服务端口
  timeout: 10000    # HTTP 请求的超时时间（毫秒）
```
