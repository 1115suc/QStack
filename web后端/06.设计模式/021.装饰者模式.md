...
![装饰者模式 - 使用前.png](img/装饰者模式 - 使用前.png)

**使用继承的方式存在的问题：**

- **扩展性不好**

  如果要再加一种配料（火腿肠），我们就会发现需要给FriedRice 和 FriedNoodles 分别定义一个子类。如果要新增一个快餐品类（炒河粉）的话，就需要定义更多的子类。
...
![装饰者模式-jdk 源码.png](img/装饰者模式-jdk源码.png)
